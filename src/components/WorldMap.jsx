...
export default function WorldMap() {
  ...
  const [stockSource, setStockSource] = useState("wb");
  ...
  const { migrationData, chartData, mData, chartInfo } = useMapData(intervalMode, selectedPeriods, selected, stockSource);
